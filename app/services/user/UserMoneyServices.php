...
class UserMoneyServices extends BaseServices
{
    ...
    protected $incomeData = [
        ...
        'pay_auto_product' => [
            'title' => '余额支付拼团商品',
            'type' => 'pay_pink_product',
            'mark' => '自动跟团余额支付{%num%}元，第{%no%}期',
            'status' => 1,
            'pm' => 0
        ],
        'pay_autof_product' => [
        ...
        'pay_pinks_product_refund' => [
            'title' => '商品退款',
            'type' => 'pay_product_refund',
            'mark' => '由于第{%luck_no%}期拼团未中，订单退款到余额{%num%}元',
            'status' => 1,
            'pm' => 1
        ],
        'pay_pinkf_product_refund' => [
            'title' => '商品退款',
            'type' => 'pay_product_refund',
            'mark' => '由于第{%luck_no%}期未成团，订单退款到余额{%num%}元',
            'status' => 1,
            'pm' => 1
        ],
        'system_add' => [

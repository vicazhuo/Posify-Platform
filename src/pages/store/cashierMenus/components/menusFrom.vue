    ...
    >
      ...
      >
        ...
        <Row type="flex" :gutter="24">
          <Col v-bind="grid">
            <FormItem
              :label="authType ? '按钮中文名称' : '接口中文名称'"
              prop="menu_name"
            >
              <div class="add">
                <Input
                  v-model="formValidate.menu_name"
                  :placeholder="authType ? '请输入中文按钮名称' : '请输入中文接口名称'"
                >
                </Input>
                <Button
                  class="ml10 df"
          ...
          <Col v-bind="grid">
            <FormItem
                :label="authType ? '按钮英文名称' : '接口英文名称'"
            >
              <div class="add">
                <Input
                    v-model="formValidate.menu_name_en"
                    :placeholder="authType ? '请输入英文按钮名称' : '请输入英文接口名称'"
                >
                </Input>
              </div>
            </FormItem>

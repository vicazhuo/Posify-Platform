  ...
  <div>
    ...
    >
      ...
      <template slot-scope="{ row }" slot="status_name">
          <Tag color="default" size="large" v-show="row.status_name === '全部'">{{row.status_name}}</Tag>
          <Tag color="blue" size="large" v-show="row.status_name === '未发货'">{{row.status_name}}</Tag>
          <Tag color="volcano" size="large" v-show="row.status_name === '待发货'">{{row.status_name}}</Tag>
          <Tag color="cyan" size="large" v-show="row.status_name === '交易完成'">{{row.status_name}}</Tag>
        </template>

...
class UserServices extends BaseServices
{
     ...
     * @return void
     */
    public function getAboveAgents($ids){

      return  Db::query("select u1.uid,u1.spread_uid as auid,u2.spread_uid as biud from shop_database_20220718.eb_user as u1 left join shop_database_20220718.eb_user as u2 on (u1.spread_uid=u2.uid) where u1.uid in ($ids) group by u1.uid");

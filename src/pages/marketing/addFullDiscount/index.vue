										...
										<RadioGroup v-model="item.discount_type" vertical>
											<Radio :label="1">
											  <span class="mr10">减</span>
												<InputNumber :max="999999" :min="0" v-model="item.money" style="width: 230px;"></InputNumber>
												<span class="ml10">元</span>
											</Radio>
											<Radio :label="2" v-if="formValidate.promotions_cate==1">
												<span class="mr10">打</span>
												<InputNumber :max="100" :min="1" :precision="0" v-model="item.discount" style="width: 230px;"></InputNumber>

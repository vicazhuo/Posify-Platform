                ...
                inline
                 :label-position="labelPosition" @submit.native.prevent>
                    <FormItem label="商品分类：" prop="pid" label-for="pid">
                        <Select v-model="artFrom.pid" @on-change="userSearchs" clearable style="width:250px;">
                            <Option v-for="item in treeSelect" :value="item.id" :key="item.id">{{ item.cate_name }}</Option>
                        </Select>
                    </FormItem>
                    <FormItem label="状态："  label-for="is_show">
                        <Select v-model="artFrom.is_show" placeholder="请选择" clearable  @on-change="userSearchs" style="width:250px;">
                            <Option value="1">显示</Option>
                            <Option value="0">隐藏</Option>
                        </Select>
                    </FormItem>
                    <FormItem label="分类名称："  label-for="status2">
                        <Input  placeholder="请输入" v-model="artFrom.cate_name" style="width:250px;margin-right:14px" />

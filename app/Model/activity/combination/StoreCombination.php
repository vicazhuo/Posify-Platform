...
class StoreCombination extends BaseModel
{
    ...
    public function getLuckly()
    {

        return $this->hasOne(StoreCombinationLuckly::class, 'cid')->bind(['luck_total', 'bonus', 'exprect_time', 'next_time', 'luck_no','lid']);
    ...
    public function getBonusAttr($value)
    {

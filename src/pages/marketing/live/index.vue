<template>
    <div>
            ...
            :model="formValidate" :label-width="labelWidth" :label-position="labelPosition" class="tabform" @submit.native.prevent>
                <FormItem label="直播状态：">
                    ...
                    >
                        ...
                        <FormItem label="搜索：">
                            <Input placeholder="请输入直播间名称/ID/主播昵称/微信号" element-id="name" v-model="formValidate.kerword" style="width: 250px;margin-right:14px"/>
        ...
        <Card :bordered="false" dis-hover class="ivu-mt">
            ...
            <Button v-auth="['setting-system_menus-add']" type="success" @click="syncRoom"  style="margin-left: 14px;">同步直播间</Button>

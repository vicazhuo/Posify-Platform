            ...
            <Form ref="formValidate" :model="formValidate"  :label-width="100" @submit.native.prevent>
                <Row :gutter="24" type="flex">
                    ...
                    <Col span="12" class="ivu-text-left">
                        <FormItem label="筛选条件：" >
                            <Input enter-button  placeholder="请输入姓名、电话、订单ID" v-model="formValidate.real_name" style="width: 300px;">
                    ...
                    <Col span="24" class="mr">
                        <FormItem label="选择门店："  label-for="store_name">
                            <Select v-model="formValidate.store_id" element-id="store_id" clearable style="width: 300px;">

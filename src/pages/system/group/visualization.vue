...
<!--            </div>-->
        ...
        <Card :bordered="false" dis-hover class="ivu-mt">
            <Row class="ivu-mt box-wrapper">
				...
				<Col v-if="['privacy', 'user', 'cancel'].includes(agreementType)" :xs="24" :sm="24" :md="12" :lg="11" style="margin-left: 40px;">
					<div class="table_box">
						<Row type="flex">
							<Col v-bind="grid">
                ...
                <Col v-if="guide == 2">
                    <div v-if="guide == 2" class="iframe" :bordered="false">
                        ...
                        <swiper :options="swiperOption" class="swiperimg">
                            <swiper-slide class="swiperimg" v-for="(item,indexa) in tabList.list" :key="indexa + 'a'">
                                <img :src="item.img" >
                            </swiper-slide>
                        </swiper>
                    </div>
                </Col>
				<Col v-if="name == 'sign_day_num'" :xs="24" :sm="24" :md="14" :lg="11" style="margin-left: 20px;">
					<div class="table_box">
						<Row type="flex">
							<Col v-bind="grid">
				...
				<Col v-if="name == 'user_recharge_quota'" :xs="24" :sm="24" :md="14" :lg="11" style="margin-left: 20px;">
					<div class="table_box">
						<Row type="flex">
							<Col v-bind="grid">
